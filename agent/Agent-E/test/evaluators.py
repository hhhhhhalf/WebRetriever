...
class Evaluator:
    ...
    def __call__(self, task_config: dict[str, Any], page: Page, client: CDPSession, answer: str) -> dict[str, float|str]:
...
class EvaluatorComb(Evaluator):
    ...
    def __call__(
        ...
        for evaluator in self.evaluators:
            eval_result = evaluator(task_config, page, client, answer)
