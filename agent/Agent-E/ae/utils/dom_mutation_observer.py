...
def add_mutation_observer(page:Page):
    """
...
def handle_navigation_for_mutation_observer(page:Page):
    add_mutation_observer(page)

def dom_mutation_change_detected(changes_detected: str):
    """
