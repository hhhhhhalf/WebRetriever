...
def extract_text_from_pdf(pdf_url: Annotated[str, "The URL of the PDF file to extract text from."]) -> Annotated[str, "All the text found in the PDF file."]:
    """
    ...
    try:
        ...
        # Download the PDF
        download_result = download_pdf(pdf_url, file_path)
        ...
        browser_manager.notify_user(f"Extracted text from the PDF successfully. Found {word_count} words.", message_type=MessageType.ACTION)
