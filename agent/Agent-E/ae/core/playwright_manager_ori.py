...
from playwright.sync_api as playwright
...
class PlaywrightManager:
    ...
    def start_playwright(self):
        ...
        if not PlaywrightManager._playwright:
            PlaywrightManager._playwright: Playwright = playwright().start()
    ...
    def create_browser_context(self):
        ...
        if self.browser_type == "chromium":
            ...
            try:
                PlaywrightManager._browser_context = PlaywrightManager._playwright.chromium.launch_persistent_context(user_dir,
                ...
                if "Target page, context or browser has been closed" in str(e):
                    ...
                    PlaywrightManager._browser_context = PlaywrightManager._playwright.chromium.launch_persistent_context(new_user_dir,
                        channel= "chrome", headless=self.isheadless,
                        args=["--disable-blink-features=AutomationControlled",
                            "--disable-session-crashed-bubble",  # disable the restore session bubble
                            "--disable-infobars",  # disable informational popups,
